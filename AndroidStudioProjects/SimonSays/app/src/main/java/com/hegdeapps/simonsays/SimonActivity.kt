...
class SimonActivity : AppCompatActivity(), View.OnClickListener {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mImgView[0]!!.setCellType(SimonCell.CELL_TYPE_BLUE)
        mImgView[1]!!.setCellType(SimonCell.CELL_TYPE_GREEN)
        mImgView[2]!!.setCellType(SimonCell.CELL_TYPE_RED)
        mImgView[3]!!.setCellType(SimonCell.CELL_TYPE_YELLOW)
        for (i in 0..3) {
